...
// 1. We isolate the form logic that reads URL parameters into a separate child component
...
// 2. The primary page export safely wraps the content in a Suspense loader block to fix the pre-render failure
